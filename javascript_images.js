...
// 選取會使用的element
const carousel = document.querySelector("a3_all");
const container = document.querySelector("#a3_images");
const allContent = document.querySelectorAll("#a3_image");
const content = document.querySelector("#a3_image");
const prevBtn = document.querySelector(".btn-prev");
const nextBtn = document.querySelector(".btn-next");
const contentComputeStyle = getComputedStyle(a3_image);

// 取得輪播內容物個數
const contentAmount = document.querySelectorAll("a3_image").length;
